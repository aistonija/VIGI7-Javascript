...
Doctor​
    ...
    Properties: _name, _remainingVacationDays (set to 20 inside the constructor()), specialty,
...
const docHarold = new Doctor("Harold", "Family doctor");
console.log(docHarold.specialty);
